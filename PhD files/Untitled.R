...
serosolver_wd <- "~/Documents/GitHub/fluscape_infection_histories/serosolver/"

devtools::load_all(serosolver_wd)


run_name <- "fluscape_annual"
main_wd <- "~/Users/augustinemasinde/Documents/GitHub/fluscape_infection_histories//"
...
titre_dat <- read.csv("/Users/augustinemasinde/Documents/GitHub/fluscape_infection_histories/data/fluscape_data_1_resolution.csv",stringsAsFactors = FALSE)
